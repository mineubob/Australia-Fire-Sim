...
pub fn update_moisture_timelag(
    ...
    let new_moisture = equilibrium_moisture + (current_moisture - equilibrium_moisture) * lag_factor;
...
impl FuelMoistureState {
    ...
    pub fn update(
        ...
        self.moisture_1h = update_moisture_timelag(
            self.moisture_1h,
            emc,
            fuel.timelag_1h,
            dt_hours,
        ...
        self.moisture_10h = update_moisture_timelag(
            self.moisture_10h,
            emc,
            fuel.timelag_10h,
            dt_hours,
        ...
        self.moisture_100h = update_moisture_timelag(
            self.moisture_100h,
            emc,
            fuel.timelag_100h,
            dt_hours,
        ...
        self.moisture_1000h = update_moisture_timelag(
            self.moisture_1000h,
            emc,
            fuel.timelag_1000h,
            dt_hours,
...
mod tests {
    ...
    fn test_timelag_update_convergence() {
        ...
        assert!((moisture - target).abs() < 0.01, "Moisture was {} vs target {}", moisture, target);
    }
    ...
    fn test_fine_fuel_responds_faster() {
        ...
        assert!((moisture_1h - target).abs() < (moisture_100h - target).abs(),
    ...
    fn test_moisture_state_update() {
        ...
        assert!(state.average_moisture < 0.15, "Moisture should decrease in hot/dry conditions");
    }
    ...
    fn test_diurnal_moisture_cycle() {
        ...
        assert!(night_moisture > day_moisture, 
               "Moisture should recover at night: day={}, night={}", day_moisture, night_moisture);
    }
}
